...
export function Footer({ theme }:FooterProps) {
  ...
  return (
    <footer className={`py-16 relative overflow-hidden transition-all duration-300 ${
      isDark 
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2">
            ...
            <p className={`mb-4 max-w-md ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              Your go-to platform for discovering and tracking programming problems 
        ...
        <div className={`border-t pt-8 flex flex-col md:flex-row justify-between items-center ${
          ...
          <p className={`mb-4 md:mb-0 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
